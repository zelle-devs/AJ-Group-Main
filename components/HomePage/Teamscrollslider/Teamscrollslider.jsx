...
export default function TeamScrollSlider({
  ...
  showDots = true,
  showHint = true,
  showActivePanel = false, // Active card name/designation panel
    ...
    <section className="tss-wrapper" ref={wrapperRef}>
      <div className="tss-sticky">
        ...
        <div className="tss-inner container2">
          ...
          >
            {eyebrow && <span className="tss-eyebrow">{eyebrow}</span>}
            ...
            {body && <p className="tss-body-text">{body}</p>}

            {showButton && buttonText && (
              <a href={buttonLink} className="btn btn-outline-gold tss-btn">
                {buttonText} {showArrow && <ArrowRight size={16} />}
              </a>
            )}

            {/* Active Panel - Optional */}
            {showActivePanel && (
