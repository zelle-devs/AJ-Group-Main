    ...
    <section className="aj-cta-section">
      <div className="container2">
        <div className="aj-cta-wrapper">
          ...
          {/* Content Grid */}
          <div className="aj-cta-grid">
            {/* Left Side - Headline + Body */}
            <motion.div 
              className="aj-cta-content"
            ...
            >
              ...
              <motion.a 
                ...
                className="btn btn-gold aj-cta-primary-btns"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              <motion.a 
                ...
                className="btn btn-outline-gold aj-cta-secondary-btns"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
