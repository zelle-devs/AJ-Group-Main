...
export default function CapabilitiesSectionApproachMainOurPortfolioAmbition({
    // Content Props
    ...
    title2 = 'The Portfolio Will Change \n  \n The Vision Will Not',
    ...
    return (
        <section className="aj-cap-section">
            <div className="aj-cap-container">
                ...
                <h2 className="aj-cap-title" style={{color:'var(--color-gold)', fontSize:'24px', whiteSpace:'pre-line', lineHeight:'15px'}}>{title2}</h2>
