...
export default function CapabilitiesSectionAbout2MainPortfolio({
    // Content Props
    ...
    title2 = 'The Portfolio Will Evolve',
        ...
        <section className="aj-cap-section">
            <div className="aj-cap-container">
                ...
                >
                    ...
                    {body && <p className="aj-cap-body">{body}
                         <span className="aj-ptm-word aj-ptm-accent" style={{ '--i': 3, fontSize:'16px', fontWeight:'600', margin:'0px 10px' }}>The Portfolio Will Evolve </span> 
                       
                        {dec2}</p>}

                {/* <h2 className="aj-cap-title" style={{color:'var(--color-gold)', fontSize:'24px'}}>{title2}</h2> */}
