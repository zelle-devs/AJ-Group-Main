...
export default function WhyChooseUsPortfolioPageMain({
  // Content Props
  eyebrow = 'THE FUTURE',
  eyebrows2 = 'Great businesses are built for the long term',
  headline = 'Businesses, Opportunities, More To Built ',
description = "The companies within our portfolio are part of the foundation. Our ambition is to build far beyond the foundation. AJ Group is actively exploring opportunities to create, acquire and grow businesses across sectors",
