...
export default function WhyChooseUs({
  // Content Props
  eyebrow = 'Who we are',
  headline = 'One group. Four companies. A single standard of making.',
  description = "A.J Group brings specialist manufacturing and design businesses under one roof: architectural metalwork, premium packaging, advertising production, and consumer design brands. Each leads in its own field; all share one discipline: precise engineering, controlled production, and finishing that holds up to inspection. It's a group built to carry a brief from concept to finished object without the work ever leaving our hands.",
