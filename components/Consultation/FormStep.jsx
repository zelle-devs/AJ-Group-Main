            ...
            <div className="form-container-left">
                <div className="form-card">
                    ...
                    <div className="row2">
                        ...
                        <CustomSelect label="Designation" value={formData.jobTitle} fieldName="jobTitle" placeholder="Select Designation" options={jobTitleOptions} required={false} />
                    </div>

                    <div className="row2">
                        <CustomSelect label="Company Size" value={formData.companySize} fieldName="companySize" placeholder="Select Company Size" options={companySizeOptions} required={false} />
                        <CustomSelect label="Industry" value={formData.industry} fieldName="industry" placeholder="Select Industry" options={industryOptions} required={false} />
                    </div>
