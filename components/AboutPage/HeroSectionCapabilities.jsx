...
export default function HeroSectionCapabilities({
  // Content Props
  eyebrow = 'Our Capabilities',
  headline = 'Build to Turn Opportunity Into Enterprise',
      ...
      <section className="aj-about-section">
        <div className="container2">
          <div className="aj-about-grid" style={{gap:'50px'}}>
            ...
            <h2 style={{fontWeight:'700', color:'var(--color-gold)' ,fontFamily:'Gotham'}}>THINK, BUILD, OPERATE, SCALE</h2>
            <br/>
