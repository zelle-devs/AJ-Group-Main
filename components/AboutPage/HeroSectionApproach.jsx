...
export default function HeroSectionApproach({
  // Content Props
  eyebrow = 'Our Approach',
  headline = 'We Don\'t Chaise Growth, We Build It',
  body = "AJ Group takes a long-term approach to building businesses, deploying capital and creating opportunities. We look beyond the immediate. We identify potential, build with purpose, invest strategically and create the foundations for businesses that can grow far beyond where they begin.",
      ...
      <section className="aj-about-section">
        <div className="container2">
          <div className="aj-about-grid" style={{gap:'50px'}}>
            ...
            <h2 style={{fontWeight:'700', color:'var(--color-gold)' ,fontFamily:'Gotham', fontSize:'20px'}}>SEE THE OPPORTUNITY, BUILD THE VALUE</h2>
            <br/>
