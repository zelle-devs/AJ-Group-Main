...
import { Target, Award, Shield, TrendingUp, Users, Star, Heart, Briefcase, GraduationCap, Clock, ShoppingBag, Building2, Hotel, Globe, MessageSquare, BriefcaseBusiness, MoveUpRight, Eye, LucideRemoveFormatting, GitBranch, Scale } from 'lucide-react';
...
import CTASection2ContactPage from "@/components/HomePage/CTASection/CTASection2ContactPage";
  ...
  return (
    <>
      <HeroSectionCareers
        ...
        imageSrc="/CareersFinalUpdatedHeroImage.png"
      ...
      <div className="scroll-content-wrapper">
        ...
        <WhyAJGroup
          ...
          columns={5}
          items={[
            { num: '01', icon: BriefcaseBusiness, title: 'Meaningful Responsibility', desc: 'Take ownership of work that matters.', image: 'Skills_Careers_Cards.jpeg' },
            { num: '02', icon: TrendingUp, title: 'Learning By Doing', desc: 'Grow through real challenges, not just training rooms.', image: 'Inisiative_Careers_Cards.jpeg' },
            { num: '03', icon: Eye, title: 'Exposure To Picture', desc: 'Understand how businesses are built, operated and grown.', image: 'Care_Careers_Cards.jpeg' },
            { num: '04', icon: GitBranch, title: 'Room To Move', desc: 'As AJ Group expands, new roles, responsibilities and opportunities will emerge.', image: 'Standerds_Responsibilities_Cards.jpeg' },
            { num: '05', icon: Scale, title: 'Culture Accountability', desc: 'We give people responsibility — and expect them to rise to it.', image: 'TeamWork_Careers_Cards.jpeg' },
          ]}
        />
